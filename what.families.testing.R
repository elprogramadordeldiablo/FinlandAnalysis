...
TAlphaAll.glmm.1 = glmmTMB(TAlphaAll ~    (1 | ForestID), data= Results2,family = nbinom1) 
################ks.test(Results2$TAlphaAll, "poisson")
what.family(TAlphaAll.glmm.1) 
TAlphaNat.glmm.2 = glmmTMB(TAlphaNat ~    (1 | ForestID), data= Results2,family = nbinom1) 
what.family(TAlphaNat.glmm.2) 
TAlphaNInd.glmm.3 = glmmTMB(TAlphaNInd ~    (1 | ForestID), data= Results2,family = nbinom1) 
what.family(TAlphaNInd.glmm.3) 
TAlphaNInd.glmm.4 = glmmTMB(TAlphaNInd ~  Dist_trail_beginning_std + (1 | ForestID), data= Results2,family = nbinom1) 
what.family(TAlphaNInd.glmm.4) 
TAlphaNInd.glmm.5 = glmmTMB(TAlphaNInd ~   Dist_trail_std +(1 | ForestID), data= Results2,family = nbinom1) 
...
### Ver o histograma da variável dependente

par(mfrow=c(5,6))
hist(Results2$TAlphaAll) 
hist(Results2$TAlphaNat) 
hist(Results2$TAlphaNInd) 
hist(Results2$FAlphaAll) 
hist(Results2$FAlphaNat) 
hist(Results2$FAlphaNInd) 
hist(Results2$abund.all) 
hist(Results2$abund.nat) 
hist(Results2$abund.nind) 
hist(Results2$prop.Talpha) 
hist(Results2$prop.Falpha) 
hist(Results2$prop.abund) 
hist(Results2$all.tax.btotal) 
hist(Results2$all.tax.brich) 
hist(Results2$all.tax.brepl) 
hist(Results2$nat.tax.btotal) 
hist(Results2$nat.tax.brich) 
hist(Results2$nat.tax.brepl) 
hist(Results2$nind.tax.btotal) 
hist(Results2$nind.tax.brich) 
hist(Results2$nind.tax.brepl) 
hist(Results2$all.func.btotal) 
hist(Results2$all.func.brich) 
hist(Results2$all.func.brepl) 
hist(Results2$nat.func.btotal) 
hist(Results2$nat.func.brich) 
hist(Results2$nat.func.brepl) 
hist(Results2$nind.func.btotal) 
hist(Results2$nind.func.brich) 
hist(Results2$nind.func.brepl) 
